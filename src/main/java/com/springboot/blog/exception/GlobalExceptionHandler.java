...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler { // ResponseEntityExceptionHandler is a class provided by Spring Boot to handle exceptions globally
    //Specific Exceptions
